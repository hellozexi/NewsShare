...
<main role="main" class="container">
    ...
    echo " <div class=\"starter-template\">
        ...
        <form method=\"post\" action=\"refreshComment.php\">
            Content:<br /><textarea name=\"content\" id=\"news\" cols=\"50\" rows=\"5\"  >$content</textarea><br />
            <input name='commentId' type='hidden' value='$commentId'>
            <input name='storyId' type='hidden' value='$storyId'>
            <input name='author' type='hidden' value='$email'>
